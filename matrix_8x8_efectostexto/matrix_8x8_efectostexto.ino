...
sCatalog catalog[] =
{
  { PA_PRINT, "ELECTRONICS", 1, 1 },
  { PA_SLICE, "     ARME", 1, 1 },
  { PA_MESH, "BIENVENIDOS", 20, 1 },
  { PA_FADE, "  MATRIZ LED ", 20, 1 },
  { PA_OPENING, "ELECTRONICA", 3, 1 },
  { PA_OPENING_CURSOR, "   ROBOTICA", 4, 1 },
  { PA_SCROLL_LEFT, "MECATRONICA", 5, 1 },
  { PA_SCROLL_RIGHT, "ELECTRONICA", 5, 1 },  
  { PA_CLOSING, "  PROYECTOS", 3, 1 },
  { PA_CLOSING_CURSOR, "    ARDUINO", 4, 1 },
  { PA_BLINDS, "  ARME", 7, 1 },
  { PA_DISSOLVE, "   PANTALLA", 7, 1 },
  { PA_SCROLL_UP, "   TECNOLOGIA", 5, 1 },
  { PA_SCROLL_DOWN, "  CIRCUITOS", 5, 1 },
  { PA_SCROLL_LEFT, "ELECTRONICA", 5, 1 },
  { PA_SCAN_HORIZ, "    CIENCIA", 4, 1 },
  { PA_SCAN_VERT, " TECNOLOGIA", 3, 1 },  
  { PA_SCROLL_UP_RIGHT, "  SUSCRIBETE", 7, 1 },
  { PA_SCROLL_DOWN_RIGHT, "  COMPARTE", 7, 1 },
  { PA_SCROLL_UP, "    ARME", 5, 1 },
  { PA_SCROLL_DOWN, "   ARME", 5, 1 },
  { PA_SCROLL_LEFT, "ARME", 5, 1 },
  { PA_SCROLL_RIGHT, "ARME", 5, 1 },
#if ENA_SPRITE
  { PA_SPRITE, "SUSCRIBETE", 5, 1 },

   { PA_BLINDS, "   ARME", 7, 1 },
  { PA_RANDOM, "   ARME", 3, 1 },
#endif
#if ENA_WIPE
  { PA_WIPE, "SUSCRIBETE", 5, 1 },
  { PA_WIPE_CURSOR, "COMPARTE", 4, 1 },
#endif
#if ENA_SCAN
  { PA_SCAN_HORIZ, "Electronics", 4, 1 },
  { PA_SCAN_HORIZX, "   ARME", 4, 1 },
  { PA_SCAN_VERT, "   ROBOT", 3, 1 },
  { PA_SCAN_VERTX, "   ROBOT", 3, 1 },
#endif
#if ENA_OPNCLS
  { PA_OPENING, "ELECTRONICS", 3, 1 },
  { PA_OPENING_CURSOR, "   ARME", 4, 1 },
  { PA_CLOSING, "Electronics", 3, 1 },
  { PA_CLOSING_CURSOR, "   ARME", 4, 1 },
#endif
#if ENA_SCR_DIA
  { PA_SCROLL_UP_LEFT, "   MATRIZ", 7, 1 },
  { PA_SCROLL_UP_RIGHT, "   MATRIZ", 7, 1 },
  { PA_SCROLL_DOWN_LEFT, "   MATRIZ", 7, 1 },
  { PA_SCROLL_DOWN_RIGHT, "   MATRIZ", 7, 1 },
#endif
#if ENA_GROW
  { PA_GROW_UP, "   ARME", 7, 1 },
  { PA_GROW_DOWN, "   ARME", 7, 1 },
#endif
};
